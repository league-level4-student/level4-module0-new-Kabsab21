...
public class IntroToEncapsulation {
	...
	public static void main(String[] args) {
		...
		veh.setFuelTankCapacity(15);
		veh.setMpg(20);
		// 3. Call setFuelInTank with an amount greater than the capacity.
		veh.setFuelInTank(veh.getFuelTankCapacity()+1);
...
//yuh
		...
		int fuelcap = veh.getFuelTankCapacity();
		int fuelntan = veh.getFuelInTank();
		int mp = veh.getMpg();
		String cl = veh.getColor();
