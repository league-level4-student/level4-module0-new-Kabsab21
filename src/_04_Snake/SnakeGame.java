...
public class SnakeGame implements ActionListener, KeyListener {
	...
	private void randomizeFoodLocation() {
		 ...
		 */
		Random r = new Random();
		Location locantinus = new Location(r.nextInt(WIDTH), r.nextInt(HEIGHT));
	...
	private void gameOver() {
		...
		JOptionPane.showMessageDialog(null, "you're snake is dead..");
		// Ask the user if they want to play again.
		int agreed = JOptionPane.showConfirmDialog( null, "would you like to continue? ", null, JOptionPane.YES_NO_OPTION);
